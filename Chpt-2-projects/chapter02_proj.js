...
const EMP_COST = 100; //cost of photographers per hr
const BOOK_COST = 350; //cost of memory book
const REPRO_COST = 1250; //cost of repoduction rights
const TRAVEL_COST = 2; //cost of travel per mile

//set the form when the page loads
window.addEventListener("load", setupForm);


//set the form default valeus
function setupForm() {
